...
class CrudSystem {
     ...
     */
    function __construct($Function, $Table, $Data, $Fields, $Params) {
    ...
    private function prepareResult() {
        ...
        if ($this->Function == "SELECT") {
            return mysqli_fetch_assoc($this->executeQuery());
        } else {
    ...
    //[pt-br]Prepara a QUERY para ser Executada.[en-us] Prepare the Query.
